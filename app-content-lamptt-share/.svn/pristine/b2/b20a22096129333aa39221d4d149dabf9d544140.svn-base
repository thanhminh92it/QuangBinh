...
<@markup id="js">
   ...
   <@script src="${url.context}/res/components/searchreport/search-lib.js" group="search"/>
   <@script src="${url.context}/res/components/searchreport/search.js" group="search"/>
</@>
